...
//       return <div className="cursor-pointer rounded-xl bg-white shadow-sm hover:bg-gray-50" onClick={onClick}>
...
const OrderRow = ({ order, onClick }: { order: IOrder; onClick: () => void }) => {
  return (
    <div
      className="cursor-pointer rounded-xl bg-white shadow-sm hover:bg-gray-50 p-4 border border-gray-100"
      onClick={onClick}
    >
      <div className="flex justify-between items-center">
