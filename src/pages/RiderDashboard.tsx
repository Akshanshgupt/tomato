...
import audio from '../assets/faahhh.mp3'
...
const RiderDashboard = () => {
  ...
  formData,
  {
    headers: {
     ...
     if(user?.role!=="rider"){
        return <div className="flex min-h-[60vh] items-center justify-center text-gray-500">You are not registered as a rider</div>
     }
     ...
     if(!profile){
        return   <div className='min-h-screen bg-gray-50 px-4 py-6'>
                <div className='mx-auto max-w-lg rounded-xl bg-white p-6 shadow-sm space-y-5'>
                    ...
                    value ={adhaarNumber} onChange={e=>setAdhaarNumber(e.target.value)}
    ...
    <div className='space-y-4'>
      <div className="mx-auto max-w-md px-4 py-4">
        ...
        <div className="flex justify-center gap-2">
          ...
          {profile.isVerified &&!currentOrder && <button onClick={toggleAvailability} disabled={toggling} className={`w-full py-2 rounded-lg text-white font-semibold ${toggling? "bg-gray-400":profile.isAvailable
            ? "bg-gray-600" :"bg-[#E23744]"
          }`} >
              {
                toggling? "Updating...":profile.isAvailable
