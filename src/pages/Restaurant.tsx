...
const Restaurant = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50 px-4 py-6 space-y-6'>
      ...
      <div className="rounded-xl bg-white shaodw-sm">
          ...
          {[
            ...
            {key:"sales", label :"Sales"},
             ...
             <button key ={t.key} onClick={()=>setTab(t.key as SellerTab)} 
              className= {`flex-1 px-4 py-3 text-sm font-mdeium  transition ${tab=== t.key?"border-b-2  border-red-500 text-red-500":"text-gray-500 hover:text-gray-700"}`}
             >
