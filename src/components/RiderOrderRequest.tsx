  ...
  return (
    <div className='rounded-xl bg-white p-4 shadow-sm border-green-300 space -y-3'>
      <p className='text-center text-xs font-semibold text-red-600'>Accept within {secondsLeft}</p>
       ...
       <button  disabled ={accepting} onClick={acceptOrder} className='w-full rounded-lg bg-green-600 py-2 text-sm font-semibold text-white hover:bg-green-700 disabled:opacity'>
